<?php
require_once '../sitegenerator.php';
require_once '../network.php';
require_once '../connectivity/login.php';
...
// TODO markups for the debug methods
// OPTIMIZE
...
//NAV
    $nav = new Nav("Home", "Our Products", "The Team", "About us", "nav", "mainNav");
